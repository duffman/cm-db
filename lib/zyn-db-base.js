...
var ZynDbBase = /** @class */ (function () {
     ...
     */
    ZynDbBase.prototype.initDatabase = function (dbFilename, dbType) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.db = new sqlite3_db_2.Sqlite3Db(dbType, this.dbFullFilename);
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!connectResult)
                            throw new Error("");
                        return [3 /*break*/, 4];
                    case 3: throw new Error("Unable to connect database \"".concat(this.dbFilename, "\""));
                    case 4:
                        if (!isSelect) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.db.get(query, values)];
                    case 5:
                        result = _a.sent();
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, this.db.modify(query, values)];
                    case 7:
                        result = _a.sent();
                        _a.label = 8;
